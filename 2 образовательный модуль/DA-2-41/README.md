...
![График от куда берутся данные] (https://github.com/ellinar5/Introduction-to-the-project/raw/2 образовательный модуль/DA-2-41/График от куда берутся данные.png)
```
